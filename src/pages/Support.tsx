    ...
    <main className="min-h-screen bg-[radial-gradient(circle,#290000,#000)] p-5 text-center text-foreground">
      <div className="mx-auto max-w-[450px]">
        ...
        <button
          ...
          className="mb-4 w-full text-left text-2xl text-white/70 hover:text-white"
        >
          ←
        </button>
        ...
        <div className="mb-5 rounded-[18px] bg-white/[0.07] p-6">
          ...
          <a
            href="https://t.me/Drexsupport00"
            target="_blank"
            rel="noopener noreferrer"
          >
            <button className="w-full rounded-[10px] bg-[#2A66FF] px-4 py-3 text-lg font-medium text-white hover:opacity-80">
              Open Telegram
            </button>
          </a>
        </div>
        ...
        <div className="mb-5 rounded-[18px] bg-white/[0.07] p-6">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <button className="w-full rounded-[10px] bg-[#25D366] px-4 py-3 text-lg font-medium text-white hover:opacity-80">
              Open WhatsApp
            </button>
          </a>
        </div>
        ...
        <div className="mb-5 rounded-[18px] bg-white/[0.07] p-6">
          ...
          <a href="mailto:chiboy82300@gmail.com">
            <button className="w-full rounded-[10px] bg-primary px-4 py-3 text-lg font-medium text-white hover:opacity-80">
              Send Email
            </button>
          </a>
        </div>
        ...
        <div className="rounded-[18px] bg-white/[0.07] p-6">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground">
            ...
            <br />
            <br />
            Average response time: Within a few hours via email, or instantly via WhatsApp and Telegram.
          </p>
        </div>
